...
As the name suggests, methods in this pakage take data (signal) and decompose it into a set of component.
...
components are often called *Intrinsic Mode Functions* (IMF) to highlight that they contain an intrisic (self)
...
Do you want to see the code by yourself? Update it? Make it better? Or worse (no judgment)?
...
It should print out some value concluding that you're good to go. In case of troubles, don't hestitate to submit
